            ...
            <div class="col-md-6" id="firstInfoDiv">
                <asp:Table ID="Table1" runat="server" CssClass="table">
                    ...
                    <asp:TableRow ID="Diver1Row"  runat="server">
                        ...
                        <asp:TableCell>
                            <asp:CheckBox ID="diver_1StandbyCheckBox" AutoPostBack="true" OnCheckedChanged="standbyCheckBox_CheckedChanged" runat="server" Text="Standby" CssClass="checkbox-inline form-control-static text-info" />
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow ID="Diver2Row"  runat="server">
                       <asp:TableCell runat="server">
                        ...
                        <asp:TableCell>
                            <asp:CheckBox ID="diver_2StandbyCheckBox" AutoPostBack="true" OnCheckedChanged="standbyCheckBox_CheckedChanged" runat="server" Text="Standby" CssClass="checkbox-inline form-control-static text-info" />
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow ID="Diver3Row" runat="server">
                        ...
                        <asp:TableCell>
                            <asp:CheckBox ID="diver_3StandbyCheckBox" AutoPostBack="true" OnCheckedChanged="standbyCheckBox_CheckedChanged" runat="server" Text="Standby" CssClass="checkbox-inline form-control-static text-info" />
                        </asp:TableCell>
                    </asp:TableRow>
                ...
                <asp:Table ID="Table2" runat="server" CssClass="table">
                    ...
                    <asp:TableRow runat="server">
                        <asp:TableCell ColumnSpan="2">
                            <div class="form-control-static text-center">Gassforsyning</div>
                        </asp:TableCell>
                        <asp:TableCell>
                            <asp:Button CssClass="btn-primary btn" runat="server" id="NitroxDiveButton" OnClick="NitroxDiveButton_Click" Text="Nitroxdykk" />
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell runat="server">
                    ...
                    <asp:TableRow ID="AirsystemRow3" Visible="false">
                        <asp:TableCell runat="server">
                            <div class="form-control-static text-info">Forsyning nr 3</div>
                        </asp:TableCell>
                        <asp:TableCell runat="server">
                            <asp:TextBox ID="airsystem_3TextBox" runat="server" CssClass="form-control"></asp:TextBox>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow ID="AirsystemRow4" Visible="false">
                        <asp:TableCell runat="server">
                            <div class="form-control-static text-info">Forsyning nr 4</div>
                        </asp:TableCell>
                        <asp:TableCell runat="server">
                            <asp:TextBox ID="airsystem_4TextBox" runat="server" CssClass="form-control"></asp:TextBox>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow ID="AirsystemRow5" Visible="false">
                        <asp:TableCell runat="server">
                            <div class="form-control-static text-info">Forsyning nr 5</div>
                        </asp:TableCell>
                        <asp:TableCell runat="server">
                            <asp:TextBox ID="airsystem_5TextBox" runat="server" CssClass="form-control"></asp:TextBox>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow ID="AirsystemRow6" Visible="false">
                        <asp:TableCell runat="server">
                            <div class="form-control-static text-info">Forsyning nr 6</div>
                        </asp:TableCell>
                        <asp:TableCell runat="server">
                            <asp:TextBox ID="airsystem_6TextBox" runat="server" CssClass="form-control"></asp:TextBox>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow ID="AirsystemRow7" Visible="false">
                        <asp:TableCell runat="server">
                            <div class="form-control-static text-info">Forsyning nr 7</div>
                        </asp:TableCell>
                        <asp:TableCell runat="server">
                            <asp:TextBox ID="airsystem_7TextBox" runat="server" CssClass="form-control"></asp:TextBox>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow ID="AirsystemRow8" Visible="false">
                        <asp:TableCell runat="server">
                            <div class="form-control-static text-info">Forsyning nr 8</div>
                        </asp:TableCell>
                        <asp:TableCell runat="server">
                            <asp:TextBox ID="airsystem_8TextBox" runat="server" CssClass="form-control"></asp:TextBox>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow ID="AirsystemRow9" Visible="false">
                        <asp:TableCell runat="server">
                            <div class="form-control-static text-info">Forsyning nr 9</div>
                        </asp:TableCell>
                        <asp:TableCell runat="server">
                            <asp:TextBox ID="airsystem_9TextBox" runat="server" CssClass="form-control"></asp:TextBox>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow runat="server">
                        <asp:TableCell ColumnSpan="2">
                        ...
                        <asp:TableCell>
                             <div class="dropdown form-control-static">
                                <asp:DropDownList ID="D1of_typeDropDownList" runat="server">
                                    <asp:ListItem Value="0">OF Lett</asp:ListItem>
                                    <asp:ListItem Value="1">OF Tungt</asp:ListItem>                                   
